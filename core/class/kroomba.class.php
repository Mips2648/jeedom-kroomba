...
class kroomba extends eqLogic {
  ...
  public static function templateWidget() {
    ...
    $return['info']['string']['state'] = array(
      ...
      'test' => array(
        array(
          'operation' => "#value# == 'charge'", 'state_light' => "<img src='plugins/kroomba/core/img/kroomba_charge.png' title ='" . __('En charge', __FILE__) . "'>",
          'state_dark' => "<img src='plugins/kroomba/core/img/kroomba_charge.png' title ='" . __('En charge', __FILE__) . "'>"
        ),
        array(
          'operation' => "#value# == 'home' || #value# == 'hmUsrDock'", 'state_light' => "<img src='plugins/kroomba/core/img/kroomba_home.png' title ='" . __('Retour à la base', __FILE__) . "'>",
          'state_dark' => "<img src='plugins/kroomba/core/img/kroomba_home.png' title ='" . __('Retour à la base', __FILE__) . "'>"
        ),
        array(
          'operation' => "#value# == 'run'", 'state_light' => "<img src='plugins/kroomba/core/img/kroomba_run.png' title ='" . __('Nettoyage', __FILE__) . "'>",
          'state_dark' => "<img src='plugins/kroomba/core/img/kroomba_run.png' title ='" . __('Nettoyage', __FILE__) . "'>"
        ),
        array(
          'operation' => "#value# == 'stop'", 'state_light' => "<img src='plugins/kroomba/core/img/kroomba_stop.png' title ='" . __('Arrété', __FILE__) . "'>",
