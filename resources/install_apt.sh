...
tryOrStop apt-get install -y python3 python3-pip python3-requests python3-dev python3-venv

step 40 "Creating python 3 virtual environment"
tryOrStop python3 -m venv $VENV_DIR

step 50 "Setting up virtual environment"
